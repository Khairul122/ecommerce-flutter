                    ...
                    @forelse ($paymentMethods as $method)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form action="{{ route('admin.payment-methods.destroy', $method) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus metode ini?')">
                                    @csrf @method('DELETE')
                                    ...
                                    <form method="POST" action="{{ route('admin.payment-methods.update', $method) }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="type" value="{{ $method->type }}" class="form-control" required>
                                            </div>
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.payment-methods.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label class="form-label">Tipe</label>
                            <input type="text" name="type" class="form-control" required placeholder="transfer_bank, cod, e-wallet, dll">
                        </div>
                        <div class="form-check">
